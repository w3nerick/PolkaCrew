...
The contract intentionally does not trust a central game verifier. The v0.4 frontend fetches the replay back from Bulletin, canonicalizes it, recomputes the match hash and refuses to attest on a mismatch.
